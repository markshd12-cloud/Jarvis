...
<div
	class="shadow-lg ring inset-shadow-sm inset-ring shadow-black/20 ring-black/5 inset-shadow-white/10 inset-ring-white/10"></div>
```
...
<div class="perspective-distant">
	<div class="translate-z-8 rotate-x-12 rotate-y-6 transform-3d">
...
<div
	popover
	class="transition-opacity open:opacity-100 starting:open:opacity-0">
